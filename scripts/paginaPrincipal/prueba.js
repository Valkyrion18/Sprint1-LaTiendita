...
import { crearYElegirDivisas } from './elegirDivisa.js'
...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    data.forEach(prenda => {
        ...
        bloque.style.width = "16rem"

        const { id, nombre, imagen, precio } = prenda;
        bloque.innerHTML = `
            <img src="${imagen}" id="img${id}" class="card-img-top mt-2" alt="imagen${id}" style="cursor:pointer" data-bs-toggle="modal" data-bs-target="#exampleModal">
            <div class="card-body">
...
export async function mostrarVentanaModalCarrito() {
    ...
    document.getElementById('totalPagar').textContent = 'Monto a pagar: ' + valor.divisa + ' ' + valor.suma
